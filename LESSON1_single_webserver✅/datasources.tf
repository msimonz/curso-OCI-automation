...
data "oci_core_vnic_attachments" "msimonz-Webserver1_VNIC1_attach" {
...
data "oci_core_vnic" "msimonz-Webserver1_VNIC1" {
  vnic_id = data.oci_core_vnic_attachments.msimonz-Webserver1_VNIC1_attach.vnic_attachments.0.vnic_id
}
